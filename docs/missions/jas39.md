...
* **Hotkey.** Not specified. Default 1 applies: pick an unused key and flag it for checking against the game's bindings. Hotkey while another mission runs: preempt (default 2).
* **Default mission.** Not selectable as `mission.default_mission` (default 3).
